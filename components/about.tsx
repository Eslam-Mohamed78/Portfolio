    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">
          Node.js, Nest.js, MongoDB, and PostgreSQL
        </span>
        . I am also familiar with TypeScript and Mongoose. I am always looking
        to learn new technologies. I am currently looking for a{" "}
        <span className="font-medium">full-time position</span> as a{" "}
        <span className="font-medium">(Backend)</span> developer.
      </p>

      <p>
        <span className="italic">When I'm not coding</span>, I enjoy playing
        video games and doing exercises. I also enjoy{" "}
